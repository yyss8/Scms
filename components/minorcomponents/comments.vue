<template>
    <div class='article-comment-field'>
        ...
        <div class='article-comments' v-for='(comment,index) in comments' :key='`comment-${index}`'>
            <div>
            ...
            <div class='article-subcomments' v-for='(sub,subid) in comment.comments' :key='`sub-comment-${subid}`'>
