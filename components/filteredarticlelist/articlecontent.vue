<template>
    <div class='panel panel-default blog-content'>
        <div class='panel-body'>
            ...
            <div class='panel panel-info article-body' v-if='data.currentArticles.length != 0' v-for='(article, articleIndex) in data.currentArticles' :key='`article-${articleIndex}`'>
                <div class='panel-body'>
                    <br />
