...
<script>
    ...
    export default {
        data(){
            ...
            const { sideBarComps } = this.$store.state;
            return {
                SelfMotto:sideBarComps.SelfMotto,
                SelfIntro:sideBarComps.SelfIntro,
                QuickBtns:sideBarComps.QuickBtns,
                HotPosts:sideBarComps.HotPosts,
                modifyingName:"",
            }
        },
        methods:{
