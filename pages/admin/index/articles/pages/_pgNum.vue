<template>
    <div>
        <table class="table table-striped"> 
            ...
            <tbody>
                <tr v-for='(article,index) in articles.currentArticles' :key='`article-${index}`'>
                ...
                <div v-if='showComments'>
                    <div class='container-fluid'>
                        <table class='table table-striped'>
                            ...
                            <tbody>
                                <tr v-for='(comment,index) in modifyingArticleComments.comments' :key='`comment-${index}`'>
                                            ...
                                            <div class='dropdown-menu' style='width:400px;' :id='"comment" + index.toString()'>
                                                ...
                                                <div class="modal-body">
                                                    <table class='table table-striped'>
                                                        ...
                                                        <tbody>
                                                            <tr v-for='(sub,subid) in comment.comments' :key='`sub-comment-${subid}`'>
                                                                <th class='text-center'>
                                                                    <div class="dropdown">
                                                                        <a href='javascript:void(0)' data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class='fa fa-info-circle'></i></a>
                                                                        <div class='dropdown-menu'>
...
<script>
    ...
    export default {
        async asyncData( { req,route,store } ){
            if ( req ){
                return {
